...
public abstract class IntegrationTestBase {
    ...
    protected Training persistTraining(final Training training) {
        return trainingRepository.save(training);
    }

    protected User existingUser(final User user) {
    ...
    protected List<Training> createAllTrainings(final List<Training> trainings) {
