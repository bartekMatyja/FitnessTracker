...
class UserApiIntegrationTest extends IntegrationTestBase {
    ...
    private static User generateUserWithDate(final LocalDate date) {
    ...
    void shouldPersistUser_whenCreatingUser() throws Exception {
        ...
        final String userLastName = "Scott";
        final String userBirthdate = "1999-09-29";
        final String userEmail = "mike.scott@domain.com";
        ...
        assertThat(user.getFirstName()).isEqualTo(userName);
        assertThat(user.getLastName()).isEqualTo(userLastName);
        assertThat(user.getBirthdate()).isEqualTo(LocalDate.parse(userBirthdate));
